...
export const downloadPDF = (doc,lng) => {
  axios({
    ...
    .then((response) => {
      ...
      saveAs(pdfBlob, `${lng==='hu'?'nikolicsmilan-cv.web.app_2024_06_27_hu.pdf':'nikolicsmilan-cv.web.app_2024_06_27_en.pdf'}`); // Specify the filename for the downloaded file
    })
    .catch((error) => {
