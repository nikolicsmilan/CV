...
export const downloadPDF = (doc,lng) => {
  ...
  axios({
    ...
    .then((response) => {
      ...
      saveAs(pdfBlob, `${lng==='hu'?'nikolicsmilan-cv.web.app_2023_05_22_hu.pdf':'nikolicsmilan-cv.web.app_2023_05_22_en.pdf'}`); // Specify the filename for the downloaded file
    })
    .catch((error) => {
