...
import { motion } from "framer-motion"; // Importáljuk a Framer Motion-t
import thinking from "../../assets/advanced/thinking24.png";
import thinking2 from "../../assets/CV_Soft_pruning.jpg"
import HexagonalIconList from "./components/HexagonalIconList";
...
const generateParticles = (count) => {
  ...
  return (
    <div className="bg-primary flex flex-col lg:flex-row lg:h-full border-0 border-lime-400 lg:bg-thinkingbg bg-no-repeat bg-center bg-cover ">
